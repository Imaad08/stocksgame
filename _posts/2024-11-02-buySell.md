    ...
    <div class="header">
        ...
        <div class="buy-sell-buttons-container">
            <div class="buy-sell-buttons">
                ...
                <button class="sell-button" onclick="removeStock()">Sell</button>
            </div>
...
async function buyStock() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            outputElement.textContent = `Failed to add ${stockSymbol}. Please try again.`;
            console.error(`Failed to add ${stockSymbol}. Status code:`, response.status);
        }
    } catch (error) {
        console.error('Error adding stock:', error);
        outputElement.textContent = "Error adding stock. Please try again later.";
    }
}
async function removeStock() {
    ...
    try {
        ...
        const changeElement = document.getElementById('buysell');
        if (response.ok) {
            outputElement.textContent = `${stockSymbol} has been removed to your portfolio.`;
            changeElement.textContent = `${stockSymbol} has been removed`;
            changeElement.classList.add("negative");
            changeElement.classList.remove("positive");
            console.log(`Successfully removed 1 share of ${stockSymbol} to the portfolio.`);
        } else {
