...
<head>
    ...
    <style>
        * {
        ...
        .left-section {
            background: #e2e8f0; /* Soft gray background for a clean look */
            text-align: center;
        }
        .left-section h2 {
            font-size: 1.8rem;
        ...
        .stock-graph {
            background: #cbd5e1; /* Lighter gray box for contrast */
            border-radius: 8px;
            width: 80%;
            height: 200px;
    ...
    <div class="container">
        ...
        <div class="left-section">
            ...
            <div class="stock-graph">
                <img src="{{ site.baseurl }}/images/stock_image.png" alt="Market Overview Image" style="width:100%; height:auto;">
            </div>
        </div>
        <!-- Right Section -->
